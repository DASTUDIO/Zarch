...
namespace Z
{
    public class ZarchUnity3DConnector : MonoBehaviour
    {
        ...
        public class GoHelper
        {
            ...
            // ui
            public void image(Sprite s) { var r = go.GetComponent<Image>(); if (r) { r.sprite = s; } else { go.AddComponent<Image>().sprite = s; } }

            public Sprite image() { var r = go.GetComponent<Image>(); if (r) { return r.sprite; } return null; }

            public void text(string txt) { var r = go.GetComponent<Text>(); if (r) { r.text = txt; } else { go.AddComponent<Text>().text = txt; } }

            public string text() { var r = go.GetComponent<Text>(); if (r) { return r.text; }  return ""; }

            public void slider(float progress) { var r = go.GetComponent<Slider>(); if (r) { r.value = progress; } else { go.AddComponent<Slider>().value = progress; } }
